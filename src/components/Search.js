...
const Search = () => {
    ...
    useEffect(()=>{
        if(meaning != ""){
            // https://dictionary-app-jet-six.vercel.app
            ...
            axios.get(`https://dictionary-app-jet-six.vercel.app/api/browser?word=${wordData}`).then((response)=>{
                console.log(response);
                let json = response.data.comparedByRegion;
                console.log(json)
                setMap(json);
            }).catch((err)=> {
                console.log(err);
